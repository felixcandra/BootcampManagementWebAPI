...
namespace Common.Interface.Master
{
    public class StudentLockerRepository : IStudentLockerRepository
    {
        ...
        public bool insert(StudentLockerParam studentAccessParam)
        {
            var result = 0;
            //var getStudent = myContext.Students.Find(studentParam.Students_Id);
            //studentLocker.Students = getStudent;
            //var getLocker = myContext.Lockers.Find(LockerParam.Lockers_Id);
        ...
        public bool update(int? id, StudentLockerParam studentAccessParam)
        {
            var result = 0;
            //var getStudent = myContext.Students.Find(studentParam.Students_Id);
            //studentLocker.Students = getStudent;
