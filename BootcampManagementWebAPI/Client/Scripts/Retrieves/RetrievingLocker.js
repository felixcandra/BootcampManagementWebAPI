...
function LoadIndexLocker() {
    ...
    $.ajax({
        ...
        url: "http://localhost:53126/api/Locker",
...
function Save() {
    debugger;
    var locker = new Object(); //deklarasikan object baru yang akan disimpan nilai nilai didalamnya
    locker.Name = $('#Name').val(); // simpan nilai yang ada di #Name di view kedalam object 
    $.ajax({
        type: "POST", //insert
        url: "http://localhost:53126/api/Locker",
        datatype: "json",
        data: locker, //data yang akan disimpan adalah object yang di deklarasikan tadi
...
function Edit() {
    var locker = new Object(); // sama kayak di save
    locker.Id = $('#Id').val();// id dari data yang akan diedit
    locker.Name = $('#Name').val();// data yang akan diedit
    $.ajax({
        type: "PUT", //put untuk update
        url: "http://localhost:53126/api/Locker/" + $('#Id').val(),
        datatype: "json",
        data: locker,
...
function GetById(Id) {
    hideAlert();
    $.ajax({
        url: "http://localhost:53126/api/Locker/" + Id, // search
        type: "GET",
        datatype: "json",
        success: function (result) {
            $('#Id').val(result.Id);
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:53126/api/Locker/" + Id,
            type: "DELETE",
