...
function LoadProvince(element) {
    if (Provinces.length == 0) {
        $.ajax({
            type: "GET", // get
            url: 'http://localhost:53126/api/Organization',
...
function Edit() {
    ...
    $.ajax({
        ...
        url: "http://localhost:53126/api/Organization" + $('#Id').val(),
        datatype: "json",
        data: item,
...
function GetById(Id) {
    debugger;
    $.ajax({
        url: "http://localhost:53126/api/Organization" + Id, // search
        type: "GET",
        datatype: "json",
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:53126/api/Organization" + Id,
            type: "DELETE",
